...
#---------- Script Variables ----------#
$PackageName = "Romanitho.Winget-AutoUpdate"
$Scope = "machine"
$ScriptVersion = "v1.0"
...
if ($PackageName) {
    try {
        ...
        .\winget.exe install --id $PackageName -e --scope $Scope -h --accept-package-agreements --accept-source-agreements --disable-interactivity
        Stop-Transcript
    } Catch {
